...
<head>
    ...
    <meta name="title" content="GATE-MA-2021 Problem 7">
    <meta name="description" content="The function $u(x, t)$ satisfies the initial value problem
             $\frac{\partial^{2} u}{\partial t^{2}}=\frac{\partial^{2} u}{\partial x^{2}}, x \in \mathbb{R}, t > 0$
             $u(x, 0)=0, \frac{\partial u}{\partial t}(x, 0)=4 x e^{-x^{2}}$">
    <meta name="keywords" content="gate mathematics, GATE MA, gate 2021, wave equation, mathematics, pde, gate mathematics problem 7, d'Alembert's formula, general solution, Gate mathematics solution, ">
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-7</h2>
              The function $u(x, t)$ satisfies the initial value problem
             $\frac{\partial^{2} u}{\partial t^{2}}=\frac{\partial^{2} u}{\partial x^{2}}, x \in \mathbb{R}, t > 0$
             $u(x, 0)=0, \frac{\partial u}{\partial t}(x, 0)=4 x e^{-x^{2}}$.<br>
             Then $u(5,5)$ is
            <br><br>
            <ol type="A">
                <li>$1-\frac{1}{e^{100}}$</li> <br>
                <li>$1-e^{100}$</li> <br> 
                <li>$1-\frac{1}{e^{10}}$</li> <br>
                <li>$1-e^{10}$</li> <br>
            </ol>
            ...
            <div class="content">
                ...
                <h3 class="definition"> Definition </h3> 
                        <p> 
                            Suppose $u=u(x_1,x_2,...,x_n;t)$ be a real valued function. If $u$ satisfies $$\frac{\partial^2u}{\partial t^2}=c^2\left( \frac{\partial^2u}{\partial x_1^2}+ \frac{\partial^2u}{\partial x_2^2}+\ldots + \frac{\partial^2u}{\partial x_n^2}\right)$$ for some non-negative real constant $c$, then we say it is a <a href="https://en.wikipedia.org/wiki/Wave_equation"> wave equation</a>.  
                        </p>
                ...
                <h3 class="definition"> Theorem </h3>
                  ...
                  <p class="theorem">
                    <strong>Theorem (<a href="https://en.wikipedia.org/wiki/D'Alembert's_formula">d'Alembert's formula</a>):-</strong> The general solution of the one dimensional wave equation $$\frac{\partial^{2} u(x,t)}{\partial t^{2}}=c^2 \frac{\partial^{2} u(x,t)}{\partial x^{2}},\ \ c > 0$$ with the initial given conditions $u(x,0)=f(x)$ and $\frac{\partial u}{\partial t}(x,0)=g(x)$ is $$u(x, t)=\frac{f(x-c t)+f(x+c t)}{2}+\frac{1}{2 c} \int_{x-c t}^{x+c t} g(s) \mathrm{d} s $$.
                  </p>
                    <br>
                <!-- Hints -->
                ...
                <ol>
                    <li>
                        For $c=1$, use the d'Alembert's formula directly to get $u(x,t)$ and then put $x=t=5$. 
                    </li>
                </ol>
            </div>
            <br>
            ...
            <div class="content">
                ...
                Here as the initial conditions given in terms of $u(x,0)$ and $\frac{\partial u}{\partial t}(x,0)$, so we will use d'Alembert's formula to calculate $u(x,t)$.<br>

                By that formula putting $c=1$, we have
                \begin{align*}
                 u(x, t)=& \frac{u(x-t,0)+u(x+t,0)}{2}+\frac{1}{2} \int_{x-t}^{x+t} \frac{\partial u}{\partial t}(s,0) \mathrm{d} s\\
                 =& 0 + \frac{1}{2} \int_{x-t}^{x+t} 4se^{-s^2}\mathrm{d} s\\
                 =& \frac{1}{2} \left[ -2e^{-s^2}\right]_{x-t}^{x+t}\\
                 =& e^{-(x-t)^2}-e^{-(x+t)^2}
                \end{align*}
                Thus $u(5,5)=1-e^{-100}=1-\dfrac{1}{e^{100}}$.<br>
            ...
            <a href="problem6_2021.php"><div class="button prev">$\leftarrow$ Problem 6</div></a>
            <a href="problem8_2021.php"><div class="button next">Problem 8 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem7_2021.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">7</button> </a>
