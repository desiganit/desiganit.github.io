...
<head>
    ...
    <meta name="title" content="GATE-MA-2021 Problem 13">
    <meta name="description" content="Consider the following statements:
               P: Every compact metrizable topological space is separable.
               Q: Every Hausdorff topology on a finite set is metrizable.">
    <meta name="keywords" content="gate mathematics, GATE MA, gate 2021, metric space, topology, topological space, compact, metrizable, separable, Hausdorff, mathematics, gate mathematics problem 11, Gate mathematics solution, ">
    ...
    <!-- Title -->
   <title>Problem-13 MA-2021</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-13</h2>
              Consider the following statements:<br><br>
               P: Every compact metrizable topological space is separable.<br><br>
               Q: Every Hausdorff topology on a finite set is metrizable.<br><br>
               Then
               <br><br>
            <ol type="A">
