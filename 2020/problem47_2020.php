...
<head>
    ...
    <meta name="title" content="Problem-47 MA-2020">
    <meta name="description" content="Let $K=\mathbb{Q}(\sqrt{3+2 \sqrt{2}}, \omega),$">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 47, solution of problem 47, gate ma 2020 problem 47 solution, Let $K=\mathbb{Q}(\sqrt{3+2 \sqrt{2}}, \omega),$">
    ...
    <!-- Title -->
    <title>Problem-47 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-47</h2>
            ...
            <div class="content">
                ...
                <!-- Definitions -->
                <h3 class="definition">Concepts</h3>
                <ol>
                    <li>Let $K$ be a subfield of a field $F$ and $a\in F\setminus K$. Also let $a$ be algebraic over $K$ i.e., $a$ satisfy a polynomial in $K$. Then $K(a)$ is the smallest subfield of $F$ containing $K$ and $a$. Such extension is defined by $$K(a)=\left\{\frac{f(x)}{g(a)}:f,g\in K[x]\ \&\ g(a)\neq 0\right\}.$$ This is a finite as well as algebraic extension and the degree of the extension $K(a)$ over $K$ is the degree of the minimal polynomial of $a$ in $K$.</li><br> 
                    <li><strong>Tower lemma:-</strong> Suppose $S &rarrhk; K &rarrhk; F$ be two finite field extensions. Then $S &rarrhk; F$ is also finite extension and the degree of the extension $S$ over $F$, denoted by $[S,F]$, is the product of the degree of the internal two extensions. In short $[S,F]=[S,K]\times [K,F]$. </li> 
                ...
                <ol>
                    <li>Write the extension $\mathbb{Q} &rarrhk; K$ as $\mathbb{Q} &rarrhk; S &rarrhk; K$ for some subfield $S$ of $K$ so that the degree of each extension is known. Then apply <i>tower lemma</i>.  </li>
                </ol>
            </div>
            <br>
            ...
            Take $S=\mathbb{Q}(\omega)$. Then $\mathbb{Q} &rarrhk; S$ is degree $2$ extension (as the minimal polynomial of $\omega$ in $\mathbb{Q}$ is $\omega^2+\omega+1$, which has degree $2$).<br>
            Also $S &rarrhk; K$ has degree $2$. <font color="red">WHY? Need to prove</font>.<br>
            Then by <i>tower lemma</i>, degree of $K$ over $\mathbb{Q}$ is $2\times 2=$ <strong>$4$</strong>.
             

            </div><br><br>
            <a href="problem46_2020.php"><div class="button prev">$\leftarrow$ Problem 46</div></a>
            <a href="problem48_2020.php"><div class="button next">Problem 48 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem47_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">47</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 4";
    }
    </script>
