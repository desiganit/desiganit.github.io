...
<head>
    ...
    <meta name="title" content="Problem-45 MA-2020">
    <meta name="description" content="Suppose that $f(z)=\prod_{n=1}^{17}\left(z-\frac{\pi}{n}\right),">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 45, solution of problem 45, gate ma 2020 problem 45 solution, Suppose that $f(z)=\prod_{n=1}^{17}\left(z-\frac{\pi}{n}\right),">
    ...
    <!-- Title -->
    <title>Problem-45 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-45</h2>
            Suppose that $f(z)=\prod_{n=1}^{17}\left(z-\frac{\pi}{n}\right), ~z\in \mathbb{C}$ and $\gamma(t)=e^{2it}, ~t\in [0,2\pi]$. If $$\int_{\gamma}^{}\dfrac{f'(z)}{f(z)}\,{\rm d}z=\alpha \pi \iota$$ then the value of $\alpha$ is equal to $\_\_\_\_$.
            ...
            <div class="content">
             ...
             The parametric equation of a circle with radius $r$ and centre at origin is
             $$\gamma(t)=re^{\iota t}, \,\, t\in [0,2\pi].  $$
             The given contour $\gamma=e^{2\iota t}, \,\, t\in [0,2\pi]$ can be written as

             $$\gamma=1\cdot e^{\iota \theta}, \,\, \theta\in [0,4\pi]$$

            that is, the given contour is a unit circle with centre at origin but it is circled twice. Thus winding number of $\gamma$ for any point inside $\gamma$ is $2$.<br> <br>

            The zeros of $f(z)=\prod_{n=1}^{17}\left(z-\frac{\pi}{n}\right)$ are $\frac{\pi}{n}, n=1,2,\cdots, 17$. Notice that the points $\pi, \frac{\pi}{2}, \frac{\pi}{3}$ are outside the unit circle, hence the number of zeros inside $\gamma$ is $14$ with winding number $2$ of each and $0$ poles inside $\gamma.$ Thus, by the second version of Argument principle

            \begin{align*}
                \int_{\gamma}^{}\dfrac{f'(z)}{f(z)}\,{\rm d}z&=2\pi \iota\left(\sum_{n=4}^{17}2-\sum 0\right)\\
                &=2\pi \iota \times 14\\
                &=56\pi \iota.
            \end{align*}
            ...
            <a href="problem44_2020.php"><div class="button prev">$\leftarrow$ Problem 44</div></a>
            <a href="problem46_2020.php"><div class="button next">Problem 46 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem45_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">45</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 56";
    }
    </script>
