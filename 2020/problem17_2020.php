...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 17">
    <meta name="description" content=" Let $F$ be a field with $4096$ elements. The number of proper subfields of $F$ is">
    <meta name="keywords" content="group theory, fields, subfields, Lagrange theorem, GATE 2020 mathematics problem 17, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-17 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-17</h2>
            ...
            <div class="content">
            Here first note that $4096=2^{12}$ and by uniqueness (upto isomorphism) and existence of finite fields, any subfield of $F$ of a particular order is unique.<br>
            <strong>Claim:-</strong> <i>Let $F_q$ be the finite field with $q = p^n$ elements, $p$ prime. Then every subfield of $F_q$ has order $p^m$, where $m$ is a positive divisor of $n$.}</i> <br>
            <i>Proof:-</i> First if $S$ be a subfield of order $l$ of $F_q$, then $(S,+)\leq (F_q,+)$ and $(S\setminus \{0\},\cdot)\leq (F_q\setminus \{0\},\cdot)$. So we must have $l|q$ and $(l-1)|(q-1)$.<br>
            Thus $l=p^m$ for some $0\leq m\leq n$ and $(p^m-1)|(p^n-1)$. <font color="red">This will imply $n=mq$ for some $q$ i.e., $m|n$.</font> <br>
            Hence the number of proper subfield of $F$ is the number of proper divisors of $12=2^2\cdot 3$, which is $(2+1)(1+1)-1=6-1=5$.
                  
            </div><br><br>
            <a href="problem16_2020.php"><div class="button prev">$\leftarrow$ Problem 16</div></a>
            <a href="problem18_2020.php"><div class="button next">Problem 18 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem17_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">17</button> </a>
