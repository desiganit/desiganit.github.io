...
<head>
    ...
    <meta name="title" content="Problem-35 MA-2020">
    <meta name="description" content="Suppose that $$X=\{(0,0)\} \cup\left\{\left(x, \sin \frac{1}{x}\right): x \in \mathbb{R}">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 35, solution of problem 35, gate ma 2020 problem 35 solution, Suppose that $$X=\{(0,0)\} \cup\left\{\left(x, \sin \frac{1}{x}\right): x \in \mathbb{R}">
    ...
    <!-- Title -->
    <title>Problem-35 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-35</h2>
            Suppose that $$X=\{(0,0)\} \cup\left\{\left(x, \sin \frac{1}{x}\right): x \in \mathbb{R} \backslash\{0\}\right\}$$ and $$Y=\{(0,0)\} \cup\left\{\left(x, x \sin \frac{1}{x}\right): x \in \mathbb{R} \backslash\{0\}\right\}$$ are metric spaces with metrics induced by the Euclidean metric of $\mathbb{R}^{2}$. Let $B_{X}$ and $B_{Y}$ be the open unit balls around (0,0) in $X$ and $Y,$ respectively. Consider the following statements: 
            <br><br>
            <ol type="I">
                <li>The closure of $B_{X}$ in $X$ is compact. </li>
                <br>
                <li>The closure of $B_{Y}$ in $Y$ is compact.</li>
            </ol>
            <br>
            <ol type="A">
            ...
            <div class="content">
             ...
             In the induced metric from $\mathbb{R}^2$, both $X$ and $Y$ are metric spaces.
             <br>
            Now the closure of the unit open ball in $X$ is the union of closed unit ball in $X$ and $\{(0,y):-1\leq y\leq 1\}$.
            <br>
            <div class="text-center">
                <figure>
                  <img src="Images_2020/Problem35(1)_2020.svg" height="80%" width="80%" class="rounded" alt="Integral Image">
                  <figcaption>Fig.1 - The set $X$ and unit ball $B_X$ </figcaption>
                </figure>
            </div>
            <br>
            Figure 1 shows that that the closure of the unit open ball $B_X$ in $X$ is the infinite disjoint union of the parts of graph of $y=\sin (1/x)$ with the part $\{(0,y):-1\leq y\leq 1\}$ of $Y-$ axis, which are open in $B_X$ in induced from $\mathbb{R}^2$. So clearly they do not have any finite subcover and consequently the closure of the unit ball $B_X$ in $X$ is not compact. Thus I is <strong>FALSE</strong>.
            <br><br>
            Now the closure of the open unit ball $B_Y$ in $Y$ is just the closed unit ball in $Y$.
            <br>
            <div class="text-center">
                <figure>
                  <img src="Images_2020/Problem35(2)_2020.svg" height="80%" width="80%" class="rounded" alt="Integral Image">
                  <figcaption>Fig.2 - The Set $Y$ and unit ball $B_Y$ </figcaption>
                </figure>
            </div>
            <br>
            Figure 2 shows that the closure of the unit ball $B_Y$ in $Y$ is just a connected bounded part of the graph $y=x\sin (1/x)$ in $Y$, which is compact. Thus II is <strong>TRUE</strong>.
            <br>
            Hence the correct option is $(C)$.

            </div><br><br>
            <a href="problem34_2020.php"><div class="button prev">$\leftarrow$ Problem 34</div></a>
            <a href="problem36_2020.php"><div class="button next">Problem 36 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem35_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">35</button> </a>
