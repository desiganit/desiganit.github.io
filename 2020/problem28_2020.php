...
<head>
    ...
    <meta name="title" content="Problem-28 MA-2020">
    <meta name="description" content="Let $P\in M_{m\times n}(\mathbb{R})$. Consider the following statements:">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 28, solution of problem 28, gate ma 2020 problem 28 solution, Let $P\in M_{m\times n}(\mathbb{R})$. Consider the following statements:">
    ...
    <!-- Title -->
    <title>Problem-28 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-28</h2>
            ...
            <div class="content">
             ...
             <h3 class="options">(I) If $XPY=0$ for all $X\in M_{1\times m}(\mathbb{R})$ and $Y\in M_{n\times 1}(\mathbb{R})$, then $P=0$.</h3>
               Suppose $P=(p_{ij})$, $X=(x_1\ x_2\ ...\ x_m)$ and $Y=(y_1\ y_2\ ...\ y_n)^T$. Then $$XPY=\sum_{k=1}^m\sum_{l=1}^n x_kp_{kl}y_l.$$ Now as $XPY=0$ for all appropriate $X,Y$, so if we take $X$ with $x_k=\delta_{ik}$ for $1\leq i,k\leq m$ and $Y$ with $y_l=\delta_{jl}$ for $1\leq j,l\leq n$, then $$XPY=0\Rightarrow \sum_{k=1}^m\sum_{l=1}^n x_kp_{kl}y_l=0\Rightarrow \sum_{k=1}^m\sum_{l=1}^n \delta_{ik}p_{kl}\delta_{jl}\Rightarrow p_{ij}=0.$$ So $P=0$. Hence this is <strong>TRUE</strong>.
               <br><br>

             <h3 class="options">(II) If $m=n$, $P$ is symmetric and $P^2=0$, then $P=0$.</h3>
               As $P$ is symmetric and $P^2=0$, so $P^TP=0$ and thus 
               \begin{align*}
                               & x^TP^TPx=0\text{ for any } x\in M_{n\times 1}(\mathbb{R})\\
                   \Rightarrow & (Px)^TPx=0\text{ for any } x\in M_{n\times 1}(\mathbb{R})\\
                   \Rightarrow & ||Px||^2=0\text{ for any } x\in M_{n\times 1}(\mathbb{R})\\
                   \Rightarrow & Px=0\text{ for any } x\in M_{n\times 1}(\mathbb{R})\\
                   \Rightarrow & P=0.
               \end{align*}
                So this is <strong>TRUE</strong>.

            </div><br><br>
            <a href="problem27_2020.php"><div class="button prev">$\leftarrow$ Problem 27</div></a>
            <a href="problem29_2020.php"><div class="button next">Problem 29 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem28_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">28</button> </a>
