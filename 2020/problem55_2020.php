...
<head>
    ...
    <meta name="title" content="Problem-55 MA-2020">
    <meta name="description" content="The value of $$\lim_{n\to \infty}\int_{0}^{1}nx^ne^{x^2}\,{\rm d}x$$">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 55, solution of problem 55, gate ma 2020 problem 55 solution, The value of $$\lim_{n\to \infty}\int_{0}^{1}nx^ne^{x^2}\,{\rm d}x$$">
    ...
    <!-- Title -->
    <title>Problem-55 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-55</h2>
            The value of $$\lim_{n\to \infty}\int_{0}^{1}nx^ne^{x^2}\,{\rm d}x$$
            is $\_\_\_\_\_\_\_\_\_\_\_$ (rounded off to three decimal places).
            ...
            <div class="content">
             ...
             Substituting $x^{n+1}=t$, we have $(n+1)x^n dx=dt$. At $x=0$, $t=0$ and at $x=1$, $t=1$. Thus, we get
            $$\int_{0}^{1}nx^ne^{x^2}\,{\rm d}x=\int_{0}^{1}\frac{n}{n+1}e^{t^{\frac{2}{n+1}}}\,{\rm d}t. $$

            Now $e^{t^{\frac{2}{n+1}}}$ is bounded in $(0,1)$ for all $n$, and $e^{t^{\frac{2}{n+1}}}\to e$ pointwise in $(0,1)$.<br>
            Thus, by Dominated Convergence Theorem, we have
            \begin{align*}
            \lim_{n\to \infty}\int_{0}^{1}nx^ne^{x^2}\,{\rm d}x= &\lim_{n\to \infty}\int_{0}^{1}\frac{n}{n+1}e^{t^{\frac{2}{n+1}}}\,{\rm d}t\\
            &=\int_{0}^{1}\lim_{n\to \infty}\frac{n}{n+1}e^{t^{\frac{2}{n+1}}}\,{\rm d}t\\
            &=\int_{0}^{1}1\cdot e \,{\rm d}t=e
            \end{align*}

             

            </div><br><br>
            <a href="problem54_2020.php"><div class="button prev">$\leftarrow$ Problem 54</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem55_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">55</button> </a>
    </div>
</div>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is e";
    }
    </script>
