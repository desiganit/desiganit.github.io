...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 25">
    <meta name="description" content="Let $u(x,t)$ be the solution of \begin{equation*}  \frac{\partial^2 u}{\partial t^2}-\frac{\partial^2 u}{\partial x^2}=0,\\  ~u(x,0)=f(x),~\frac{\partial u}{\partial t}(x,0)=0, x\in \mathbb{R}, t >0, \end{equation*} where $f$ is a twice continuously differentiable function.">
    <meta name="keywords" content="partial differential equation, PDE, differentiable, solution, continuous, GATE 2020 mathematics problem 25, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-25 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-25</h2>
            Let $u(x,t)$ be the solution of 
            \begin{equation*}
              \frac{\partial^2 u}{\partial t^2}-\frac{\partial^2 u}{\partial x^2}=0, ~u(x,0)=f(x),~\frac{\partial u}{\partial t}(x,0)=0, x\in \mathbb{R}, t>0,
            \end{equation*} 
            where $f$ is a twice continuously differentiable function. If $f(-2)=4$, $f(0)=0$ and $u(2,2)=8$, then the value of $u(1,3)$ is $\_\_\_\_\_$.   
            ...
            <div class="content">
             Note that here we have $c=1$ and $g(x)=0$. Thus by D'Alembert's formula 
            \begin{equation*}
              u(x,t)=\frac{1}{2}(f(x+t)+f(x-t))
            \end{equation*}
            Thus 
            \begin{equation}\label{u13}
              u(1,3)=\frac{1}{2}(f(1+3)+f(1-3))=\frac{1}{2}(f(4)+f(-2)).
            \end{equation}
            It is given that 
            \begin{align*}
              & u(2,2)=\frac{1}{2}(f(2+2)+f(2-2))\\
              \implies & 8 = \frac{1}{2}(f(4)+f(0))\\
              \implies & f(4)= 16.
            \end{align*}

            Using the value of $f(4)$ in the above equation, we get
            \begin{equation*}
                u(1,3)=\frac{1}{2}(f(4)+f(-2))=\frac{1}{2}(16+4)=10.
            \end{equation*}

            </div><br><br>
            <a href="problem24_2020.php"><div class="button prev">$\leftarrow$ Problem 24</div></a>
            <a href="problem26_2020.php"><div class="button next">Problem 26 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem25_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">25</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 10";
    }
    </script>
