...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 22">
    <meta name="description" content="Let $L^{2}[0,10]=\left\{f:[0,10] \rightarrow \mathbb{R}: f\right.$ is Lebesgue measurable and $\left.\int_{0}^{10} f^{2} d x<\infty\right\}$ equipped with the norm">
    <meta name="keywords" content="Lebesgue measurable, measure theory, functions space, norm, operator norm, GATE 2020 mathematics problem 22, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-22 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-22</h2>
            Let $L^{2}[0,10]=\left\{f:[0,10] \rightarrow \mathbb{R}: f\right.$ is Lebesgue measurable and $\left.\int_{0}^{10} f^{2} d x<\infty\right\}$ equipped with the norm $\|f\|=\left(\int_{0}^{10} f^{2} d x\right)^{\frac{1}{2}}$ and let $T$ be the linear functional on $L^{2}[0,10]$ given by
            $$
            T(f)=\int_{0}^{2} f(x) d x-\int_{3}^{10} f(x) d x
            $$
            Then $\|T\|$ is equal to $\_\_\_\_\_$.
            ...
            <a href="problem21_2020.php"><div class="button prev">$\leftarrow$ Problem 21</div></a>
            <a href="problem23_2020.php"><div class="button next">Problem 23 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem22_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">22</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 3";
    }
    </script>
