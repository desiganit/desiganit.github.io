...
<head>
    ...
    <meta name="title" content="Problem-27 MA-2020">
    <meta name="description" content="Suppose $V$ is a finite dimensional non-zero vector space over $\mathbb{C}$ and $T:V\to V$ is a linear">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 27, solution of problem 27, gate ma 2020 problem 27 solution, Suppose $V$ is a finite dimensional non-zero vector space over $\mathbb{C}$ and $T:V\to V$ is a linear">
    ...
    <!-- Title -->
    <title>Problem-27 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-27</h2>
            ...
            <br><br>
            <ol type="A">
                <li>The dimension of $V$ is even.</li>
                <br>
                <li>$0$ is the only eigenvalue of $T$.</li>
                <br>
                <li>Both $0$ and $1$ are eigenvalues of $T$.</li>
                <br>
                <li>$T^2=0$.</li>
            </ol>
            ...
            <div class="content">
             ...
             <h3 class="options">(A) The dimension of $V$ is even.</h3>
               By rank-nullity theorem dim $V$=dim Range $(T)$+dim Nullspace $(T)$, so by given condition dim $V=2\times $ dim Range $(T)$, i.e., even. So this is <strong>TRUE</strong>.
               <br><br>

             <h3 class="options">(B) $0$ is the only eigenvalue of $T$.</h3>
               If $\lambda$ is an eigenvalue of $T$, then there exists non-zero $x\in V$ such that $Tx=\lambda x$. Now if $Tx=0$, then $\lambda =0$. Otherwise by given condition, $T(Tx)=0$, which imply $\lambda Tx=0$, i.e., $\lambda=0$ (as $Tx\neq 0$). So $0$ is the only eigenvalue of $T$. So this is <strong>TRUE</strong>.
               <br><br>

             <h3 class="options">(C) Both $0$ and $1$ are eigenvalues of $T$.</h3>
               By (B), this is clearly <strong>FALSE</strong>.
               <br><br>

             <h3 class="options">(D) $T^2=0$.</h3>
               For any $x\in V,\ Tx\in$ Range $(T)=$ Nullspace $(T)$, so $T(Tx)=0$. Hence $T^2=0$. So this is <strong>TRUE</strong>.

            </div><br><br>
            <a href="problem26_2020.php"><div class="button prev">$\leftarrow$ Problem 26</div></a>
            <a href="problem28_2020.php"><div class="button next">Problem 28 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem27_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">27</button> </a>
