...
<head>
    ...
    <meta name="title" content="Problem-46 MA-2020">
    <meta name="description" content="If $\gamma(t)=\frac{1}{2}e^{3\pi \iota t}, t\in [0,2]$ and">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 46, solution of problem 46, gate ma 2020 problem 46 solution, If $\gamma(t)=\frac{1}{2}e^{3\pi \iota t}, t\in [0,2]$ and">
    ...
    <!-- Title -->
    <title>Problem-46 MA-2020</title>
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <div class="content">
             ...
             The given curve is $$\gamma(t)=\frac{1}{2}e^{\iota 3 \pi t}, t\in [0,2]$$

             which can be written as

             $$\gamma(\theta)=\frac{1}{2}e^{\iota \theta}, \theta\in [0,6 ]\pi.$$

            That is, a circle of radius $\frac{1}{2}$ and centre at $0$ and is circled $3$ times around $0$. Thus for any point inside $\gamma$ the winding number is $3$.<br>

            The given function is
            \begin{equation*}
            f(z)=\dfrac{1}{z^2(e^z-1)}
            \end{equation*}
            The only singularity is $z=0$, which is a pole of order $3$.

                    \begin{align*}
                        e^z-1&=1+z+\frac{z^2}{2!}+\frac{z^3}{3!}+\cdots-1\\
                        &=z\left(1+\frac{z}{2!}+\frac{z^2}{3!}+\cdots\right)
                    \end{align*}
            Thus

            \begin{align*}
                \dfrac{1}{e^z-1}&=\dfrac{1}{z\left(1+\frac{z}{2!}+\frac{z^2}{3!}+\cdots\right)}\\
                &=\frac{1}{z}\left(1-\left(\frac{z}{2!}+\frac{z^2}{3!}+\cdots\right)+\left(\frac{z}{2!}+\frac{z^2}{3!}+\cdots\right)^2-\cdots\right)
            \end{align*}

            \begin{equation*}
            \left(\because (1+z)^{-1}=1-z+z^2-z^3+\cdots\right)
            \end{equation*}
            Thus
            \begin{align*}
                \dfrac{1}{z^2(e^z-1)}&=\left(\dfrac{1}{z^3}-\dfrac{1}{z^3}\left(\dfrac{z}{2!}+\dfrac{z^2}{3!}+\cdots\right)+\dfrac{1}{z^3}\left(\dfrac{z}{2!}+\dfrac{z^2}{3!}+\cdots\right)^2-\cdots\right)\\
                &=\dfrac{1}{z^3}-\dfrac{1}{z^2}\left(\frac{1}{2!}\right)-\dfrac{1}{z}\left(\frac{1}{3!}-\frac{1}{(2!)^2}\right)+\cdots
            \end{align*}

            Now, the coefficient of $\frac{1}{z}$ is
            \begin{align*}
            -\frac{1}{3!}+\frac{1}{(2!)^2}=-\frac{1}{6}+\frac{1}{4}=\frac{1}{12}.
            \end{align*}
            Thus by Cauchy Residue theorem
                    \begin{align*}
                        \oint_{\gamma}\dfrac{1}{z^2(e^z-1)}=2\pi i\cdot I(\gamma, 0) \cdot Res(f,0)\\
                    \end{align*}

             <font color="red">INCOMPLETE!!</font>

            </div><br><br>
            <a href="problem45_2020.php"><div class="button prev">$\leftarrow$ Problem 45</div></a>
            <a href="problem47_2020.php"><div class="button next">Problem 47 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem46_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">46</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 0.5";
    }
    </script>
