...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 18">
    <meta name="description" content="If $\left(x_{1}^{*}, x_{2}^{*}\right)$ is an optimal solution of the linear programming problem, $$ \text { minimize } x_{1}+2 x_{2} $$ subject to">
    <meta name="keywords" content="linear programming problem, LPP, optimal solution, minimize, GATE 2020 mathematics problem 18, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-18 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-18</h2>
            ...
            \end{array}
            $$
            and $\left(\lambda_{1}^{*}, \lambda_{2}^{*}, \lambda_{3}^{*}\right)$ is an optimal solution of its dual problem, then $\sum_{i=1}^{2} x_{i}^{*}+\sum_{j=1}^{3} \lambda_{j}^{*}$
            is equal to $\_\_\_\_\_$(correct up to one decimal place).
            ...
            <a href="problem17_2020.php"><div class="button prev">$\leftarrow$ Problem 17</div></a>
            <a href="problem19_2020.php"><div class="button next">Problem 19 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem18_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">18</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 5.5";
    }
    </script>
