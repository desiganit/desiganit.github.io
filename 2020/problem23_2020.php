...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 23">
    <meta name="description" content="If $\left\{x_{13}, x_{22}, x_{23}=10, x_{31}, x_{32}, x_{34}\right\}$ is the set of basic variables of a balanced transportation problem seeking to minimize cost of transportation from origins to destinations, where the cost matrix is">
    <meta name="keywords" content="linear programming problem, LPP, transportation problem, cost matrix, basic variables, origins, destinations, GATE 2020 mathematics problem 23, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-23 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-23</h2>
            If $\left\{x_{13}, x_{22}, x_{23}=10, x_{31}, x_{32}, x_{34}\right\}$ is the set of basic variables of a balanced
            transportation problem seeking to minimize cost of transportation from origins to
            destinations, where the cost matrix is,
            $$\begin{array}{|c|c|c|c|c|c|}
            \hline & D_{1} & D_{2} & D_{3} & D_{4} & \text{Availability} \\
            \hline O_{1} & 6 & 2 & -1 & 0 & 10 \\
            \hline O_{2} & 4 & 2 & 2 & 3 & \lambda+5 \\
            \hline O_{3} & 3 & 1 & 2 & 1 & 3 \lambda \\
            \hline \text{Demand} & 10 & \mu-5 & \mu+5 & 15 & \\
            \hline
            \end{array}$$
            and $\lambda, \mu \in \mathbb{R},$ then $x_{32}$ is equal to $\_\_\_\_\_$.
            ...
            <a href="problem22_2020.php"><div class="button prev">$\leftarrow$ Problem 22</div></a>
            <a href="problem24_2020.php"><div class="button next">Problem 24 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem23_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">23</button> </a>
