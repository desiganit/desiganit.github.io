...
<head>
    ...
    <meta name="title" content="Problem-40 MA-2020">
    <meta name="description" content="Let $I$ and $J$ be the ideals generated by $\{5, \sqrt{10}\}$">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 40, solution of problem 40, gate ma 2020 problem 40 solution, Let $I$ and $J$ be the ideals generated by $\{5, \sqrt{10}\}$">
    ...
    <!-- Title -->
    <title>Problem-40 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-40</h2>
           Let $I$ and $J$ be the ideals generated by $\{5, \sqrt{10}\}$ and $\{4, \sqrt{10}\}$ in the ring $\mathbb{Z}[\sqrt{10}]=\{a+b \sqrt{10} \mid a, b \in \mathbb{Z}\},$ respectively. Then
            <br><br>
            <ol type="A">
                <li>both $I$ and $J$ are maximal ideals.  </li>
                <br>
                <li>$I$ is a maximal ideal but $J$ is not a prime ideal</li>
                <br>
                <li>$I$ is not a maximal ideal but $J$ is a prime ideal</li>
                <br>
                <li>neither $I$ nor $J$ is a maximal ideal</li>
            </ol>
            ...
            <div class="content">
                ...
                <ol>
                    <li> <strong>Prime ideal:-</strong> An ideal $I$ of a ring $R$ with unity is called <i>prime ideal</i> iff the quotient $R/I$ is an integral domain.</li> <br>
                    <li><strong>Maximal ideal:-</strong> An ideal $I$ of a ring $R$ with unity is called <i>maximal ideal</i> iff the quotient $R/I$ is a field.</li> <br>
                    <li><strong>NOTE:-</strong> These are equivalent definition of prime and maximal ideal, which are useful for this particular problem. The original definition of them are different.</li>
                </ol>

                <!-- Hints -->
                <h3 class="hints"> Hints </h3>
                <ol>
                    <li> Calculate $\frac{\mathbb{Z}[\sqrt{10}]}{I}$ and $\frac{\mathbb{Z}[\sqrt{10}]}{I}$.</li><br>
                    <li> Compare those two with some well known ring and use equivalent definition of prime and maximal ideal. </li>
                </ol>
            </div>
            <br>
            ...
            <div class="content">
             ...
             By definition of $I$ and $J$, $$I=\{5a+b\sqrt{10}:a,b\in \mathbb{Z}\}\\
             J=\{4a+b\sqrt{10}:a,b\in \mathbb{Z}\}.$$
             Let $a+b\sqrt{10}+I\in \frac{\mathbb{Z}[\sqrt{10}]}{I}$. Then we can write $a=5k+r$ for some $k\in \mathbb{Z}$ and $0\leq<5$ (by division algorithm).<br>
             So, $a+b\sqrt{10}+I=r+5k+b\sqrt{10}+I=r+I$ (as $5k+b\sqrt{10}\in I$).<br>
             Thus $\frac{\mathbb{Z}[\sqrt{10}]}{I}=\{r+I:0\leq<5\}$. This clearly isomorphic to $\mathbb{Z}_5$, which is a field. So $\frac{\mathbb{Z}[\sqrt{10}]}{I}$ is a field and consequently $I$ is a maximal ideal.<br>
             In the similar way we can show $\frac{\mathbb{Z}[\sqrt{10}]}{J}$ is isomorphic to $\mathbb{Z}_4$, which is not an integral domain. So $\frac{\mathbb{Z}[\sqrt{10}]}{J}$ is not an integral domain and consequently $J$ is not a prime ideal.<br>
             Hence (B) is <strong>TRUE</strong>.

            </div><br><br>
            <a href="problem39_2020.php"><div class="button prev">$\leftarrow$ Problem 39</div></a>
            <a href="problem41_2020.php"><div class="button next">Problem 41 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem40_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">40</button> </a>
