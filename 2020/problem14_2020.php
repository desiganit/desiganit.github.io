...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 14">
    <meta name="description" content="Let $K:\mathbb{R} \times (0,\infty)\to \mathbb{R}$ be a function such that the solution of the initial value problem $\frac{\partial u}{\partial t}=\frac{\partial^2 u}{\partial x^2}, ~u(x,0)=f(x), ~x\in \mathbb{R}, ~t>0,$ is given by">
    <meta name="keywords" content="LPP, linear programming problem, primal, dual, GATE 2020 mathematics problem 14, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-14 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-14</h2>
            ...
            \begin{equation*}\label{q140}
            u(x,t)=\int_{\mathbb{R}}K(x-y,t)f(y){\rm d}y
            \end{equation*}

            for all bounded continuous functions $f$. Then the value of $\int_{\mathbb{R}}K(x,t){\rm d}x$ is $\_\_\_\_\_$.
            ...
            <div class="content">
                ...
                The given equation is $u_t=1\cdot u_{xx}, ~u(x,0)=f(x)$, i.e., $c=1$. By using the formula its solution is 
                \begin{equation*}\label{q141}
                    u(x,t)=\frac{1}{\sqrt{4\pi t}}\int_{\mathbb{R}}e^{-\frac{(x-y)^2}{4t}}f(y){\rm d}y.
                    \end{equation*}
                Comparing this with the given solution 

                \begin{equation*}\label{q142}
                    u(x,t)=\int_{\mathbb{R}}K(x-y,t)f(y){\rm d}y,
                    \end{equation*}
                we get $$K(x-y,t)=\frac{1}{\sqrt{4\pi t}}e^{-\frac{(x-y)^2}{4t}}.$$
                 Putting $x$ in place of $(x-y)$, we get
                $$K(x,t)=\frac{1}{\sqrt{4\pi t}}e^{-\frac{x^2}{4t}}.$$
                Thus
                \begin{align*}
                \int_{\mathbb{R}}K(x,t){\rm d}x&=\int_{-\infty}^{\infty}\frac{1}{\sqrt{4\pi t}}e^{-\frac{(x-y)^2}{4t}}{\rm d}x
                \end{align*}
                Put $\frac{x}{\sqrt{4t}}=z\Rightarrow \frac{{\rm d}x}{\sqrt{4t}}={\rm d}z $ and observe that $x\to \pm \infty$ whenever $z\to \pm\infty$. Thus
                \begin{align*}
                \int_{\mathbb{R}}K(x,t){\rm d}x&=\int_{-\infty}^{\infty}\frac{1}{\sqrt{4\pi t}}e^{-z^2}\sqrt{4\pi t}{\rm d}z\\
                &=\frac{1}{\sqrt{\pi }}\int_{-\infty}^{\infty}e^{-z^2}{\rm d}z\\
                &=\frac{1}{\sqrt{\pi }}\sqrt{\pi }=1.
                \end{align*}
                  
            </div><br><br>
            <a href="problem13_2020.php"><div class="button prev">$\leftarrow$ Problem 13</div></a>
            <a href="problem15_2020.php"><div class="button next">Problem 15 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem14_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">14</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 1";
    }
    </script>
