...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 20">
    <meta name="description" content="Let $f(x)=x^4$ and let $p(x)$ be the interpolating polynomial of $f$ at nodes $1,2$ and $3$. Then $p(0)$ is equal to">
    <meta name="keywords" content="interpolation, polynomial, numerial analysis, Lagrange polynomial, nodes, GATE 2020 mathematics problem 20, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-20 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-20</h2>
            ...
            <div class="content">
             $p(x)$ is the interpolating polynomial of $f(x)=x^4$ at nodes $1,2,3$, so $p(x)$ is a quadratic polynomial such that $p(1)=f(1)=1,p(2)=f(2)=16, p(3)=f(3)=81.$ Hence by uniqueness of such polynomial (Lagrange polynomial), 
             \begin{align*}
                p(x)=& \frac{(x-2)(x-3)}{(1-2)(1-3)}f(1) +\frac{(x-1)(x-3)}{(2-1)(2-3)}f(2)+\frac{(x-1)(x-2)}{(3-1)(3-2)}f(3)\\
                =& \frac{1}{2}(x-2)(x-3)-16(x-1)(x-3)+\frac{81}{2}(x-1)(x-2)
             \end{align*} 
             Hence $p(0)=3-48+81=36.$

            </div><br><br>
            <a href="problem19_2020.php"><div class="button prev">$\leftarrow$ Problem 19</div></a>
            <a href="problem21_2020.php"><div class="button next">Problem 21 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem20_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">20</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 36";
    }
    </script>
