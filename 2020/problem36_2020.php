...
<head>
    ...
    <meta name="title" content="Problem-36 MA-2020">
    <meta name="description" content="If $f: \mathbb{C} \backslash\{0\} \rightarrow \mathbb{C}$ is a function such that">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 36, solution of problem 36, gate ma 2020 problem 36 solution, If $f: \mathbb{C} \backslash\{0\} \rightarrow \mathbb{C}$ is a function such that">
    ...
    <!-- Title -->
    <title>Problem-36 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-36</h2>
            ...
            <br><br>
            <ol type="A">
                <li>$f$ is continuous but not necessarily analytic</li>
                <br>
                <li>$f$ is analytic but not necessarily a constant function</li>
                <br>
                <li>$f$ is a constant function</li>
                <br>
                <li>$\lim _{z \rightarrow 0} f(z)$ exists</li>
            </ol>
            ...
            <div class="content">
             ...
             <h3 class="options">(A)  </h3>
               ...
               Hence the statement is <strong>TRUE</strong>.
               <br><br>

             <h3 class="options">(B)  </h3>
               
               So the statement is <strong>FALSE</strong>.
               <br><br>
            ...
            <a href="problem35_2020.php"><div class="button prev">$\leftarrow$ Problem 35</div></a>
            <a href="problem37_2020.php"><div class="button next">Problem 37 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem36_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">36</button> </a>
