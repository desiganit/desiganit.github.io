...
<head>
    ...
    <meta name="title" content="Problem-39 MA-2020">
    <meta name="description" content="Let $M=\left[\begin{array}{lll}\alpha & 3 & 0 \\ \beta & 3 & 1">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 39, solution of problem 39, gate ma 2020 problem 39 solution, Let $M=\left[\begin{array}{lll}\alpha & 3 & 0 \\ \beta & 3 & 1">
    ...
    <!-- Title -->
    <title>Problem-39 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-39</h2>
             Let $M=\left[\begin{array}{lll}\alpha & 3 & 0 \\ \beta & 3 & 1 \\ 0 & 1 & 2\end{array}\right] .$ Consider the following statements:<br>
             <ol type="I">
                 <li>There exists a lower triangular matrix $L$ such that $M=L L^{t},$ where $L^{t}$ denotes transpose of $L$</li><br>
                 <li>Gauss-Seidel method for $M x=b\left(b \in \mathbb{R}^{3}\right)$ converges for any initial choice $x_{0} \in \mathbb{R}^{3}$</li>
             </ol>
             Then
            <br><br>
            <ol type="A">
                <li>I is not true when $\alpha > \frac{9}{2}, \beta=3$</li>
                <br>
                <li>II is not true when $\alpha > \frac{9}{2}, \beta=-1$</li>
                <br>
                <li>II is not true when $\alpha=4, \beta=\frac{3}{2}$</li>
                <br>
                <li>I is true when $\alpha=5, \beta=3$</li>
            </ol>
            ...
            <a href="problem38_2020.php"><div class="button prev">$\leftarrow$ Problem 38</div></a>
            <a href="problem40_2020.php"><div class="button next">Problem 40 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem39_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">39</button> </a>
