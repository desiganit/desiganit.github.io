...
<head>
    ...
    <meta name="title" content="Problem-49 MA-2020">
    <meta name="description" content="Suppose $T:\mathbb{R}^4\to \mathbb{R}[x]$ is a linear transformation">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 49, solution of problem 49, gate ma 2020 problem 49 solution, Suppose $T:\mathbb{R}^4\to \mathbb{R}[x]$ is a linear transformation">
    ...
    <!-- Title -->
    <title>Problem-49 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-49</h2>
            ...
            <div class="content">
                ...
                <ol>
                    <li>If a set of vectors $S$ is linearly dependent, then alteast one of the vector of $S$  can be written as the linear combination of other vectors in $S$. In particular if $\{v_1,v_2,...,v_n\}$ is linearly independent but $\{v_1,v_2,...,v_n,v_{n+1}\}$ is linearly dependent, then $v_{n+1}$ can be written as linear combination of $v_1,v_2,...,v_n$. </li> 
                    <br><br>
                    <li> If a linear map is defined on a basis of a subspace, then using linearity we can define the map on the whole space.</li> 
                
                </ol>
 
                <!-- Hints -->
                <h3 class="hints"> Hints </h3>
               Write the vector $(-3,5,6,6)$ as the linear combination of the vectors whose image under $T$ is given and then use linearity of $T$, to get the required.
            </div>
            <br>
            ...
            <div class="content">
             ...
             First note that from the definition of $T$, it can be checked that $(-1,1,1,1),(1,2,3,4),(2,-1,-1,0)$ are linearly independent (apply $T$ on any linear combination of those vectors, to get linear combination of $x^2+2x^4,1-x^2,x^3-x^4$ and finally equating that to zero gives each coefficient is zero).<br><br>
            Now from asked question it natural to guess that we should be able to write the vector $(-3,5,6,6)$ as linear combination of the vectors, on which the value of $T$ is given so that we can calculate the value of $T$ on the required vector using linearity of $T$.<br> <br>
            Let $c_1(-1,1,1,1)+c_2(1,2,3,4)+c_3(2,-1,-1,0)=(-3,5,6,6)$. To find $c_1,c_2,c_3 \in \mathbb{R}.$ Writing these in matrix format and then applying row operations, we can find $c_1=2,c_2=1,c_3=-1$.<br>
            Then $T(-3,5,6,6)=2(x^2+2x^4)+(1-x^2)-(x^3-x^4)=1+x^2-x^3+5x^4$.<br>
            Hence the required coefficient of $x^4$ is <strong>$5$</strong>.

            </div><br><br>
            <a href="problem48_2020.php"><div class="button prev">$\leftarrow$ Problem 48</div></a>
            <a href="problem50_2020.php"><div class="button next">Problem 50 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem49_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">49</button> </a>
