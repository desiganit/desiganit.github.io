...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 5">
    <meta name="description" content="Let $G$ and $H$ be defined by
                                              \begin{align*}
                                              ...
                                              \end{align*}">
    <meta name="keywords" content="connecetedness, topology, complex analysis, GATE 2020 mathematics problem 5, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
          ...
          <h2 class="problem">Problem-5</h2>
            Let $G$ and $H$ be defined by
          \begin{align*}
            & G = \cbb\setminus \{z=x+\iota y\in \cbb : x\le 0,~ y=0\},\\
            & H = \cbb\setminus \{z=x+\iota y\in \cbb : x\in \zbb,~ x\le 0,~ y=0\}.\\
          \end{align*}
          Suppose $f:G\to \cbb$ and $g:H\to \cbb$ are analytic functions. Consider the following statements:
          <ol type="I">
            <li>$\displaystyle \int_\gamma f~\mathrm{d}z$ is independent of paths $\gamma$ in $G$ joining $-\iota $ and $\iota$</li>
            <br>
            <li> $\displaystyle \int_\gamma g~\mathrm{d}z$ is independent of paths $\gamma$ in $H$ joining $-\iota $ and $\iota$</li>
          </ol>
          Then
          <ol type="A">
            ...
            <div class="content">
                ...
                <h3 class="definition"> Theorem </h3>
                  We will state a theorem which can be easily proved by the Cauchy-Integral Theorem.
                  <p class="theorem">
                    <strong>Theorem:</strong> Suppose $\Omega\subseteq \cbb$ is a simply connected (any loop can by shriked to a point) region. Let $f(z)$ be analytic function on $\Omega$. Then the integral of $f$ on paths within $\Omega$ are path independent. That is,
                        $$ \int_{\gamma_1} f(z)~\mathrm{d}z = \int_{\gamma_2} f(z)~\mathrm{d}z,  $$ for any $\gamma_1,\gamma_2$ paths in $\Omega.$
                  </p>
                  In the other words, if $\Omega\subseteq \cbb$ is open, simple (i.e., does not contain any holes), and connected and $f:\Omega\to \cbb$ is analytic on $\Omega$. If $\gamma_1$ and $\gamma_2$ are two peicewise smooth paths in $\Omega$ joining $z_1,z_2 $ ($z_1,z_2\in \Omega$), then the integral $$\int_{\gamma_1}f(z)~\mathrm{d}z = \int_{\gamma_2}f(z)~\mathrm{d}z.$$

                <!-- Hints -->
                <h3 class="hints"> Hint </h3>
                 The region $G$ is simply connected whereas $H$ is not simply conneceted.
            </div>
            <br>
            ...
            <div class="content">
                ...
                Observe that the region $G$ is simply-connected because any loop can be shrinked to a point whereas $H$ is not because if we will take a circle around $z=-1$, then it cannot be shrinked to a point as $-1\notin H.$ Thus, (I) is true whereas (II) is false. (See the figue below).
              <br><br>
              <div class="text-center">
                <figure>
                  <img src="Images_2020/Problem5_2020.svg" class="rounded" alt="Integral Image">
                  <figcaption>Fig.1 - $G$ is simply connected but $H$ is not </figcaption>
                </figure>
                 
            </div>
        </div><br><br>
            <a href="problem4_2020.php"><div class="button prev">$\leftarrow$ Problem 4</div></a>
            <a href="problem6_2020.php"><div class="button next">Problem 6 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem5_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">5</button> </a>
