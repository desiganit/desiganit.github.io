...
<head>
    ...
    <meta name="title" content="Problem-43 MA-2020">
    <meta name="description" content="Let $0< p < 1$ and let $$X=\left\{f: \mathbb{R} \rightarrow \mathbb{R}">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 43, solution of problem 43, gate ma 2020 problem 43 solution, Let $0< p < 1$ and let $$X=\left\{f: \mathbb{R} \rightarrow \mathbb{R}">
    ...
    <!-- Title -->
    <title>Problem-43 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-43</h2>
            Let $0< p < 1$ and let $$X=\left\{f: \mathbb{R} \rightarrow \mathbb{R} \text { is continuous and } \int_{\mathbb{R}}|f(x)|^{p} d x<\infty\right\}$$
            For $f \in X,$ define $$|f|_{p}=\left(\int_{\mathbb{R}}|f(x)|^{p} d x\right)^{\frac{1}{p}} $$
            Then
           <br><br>
            <ol type="A">
                <li>$|\cdot|_{p}$ defines a norm on $X$ </li>
                <br>
                <li>$|f+g|_{p} \leq|f|_{p}+|g|_{p}$ for all $f, g \in X$</li>
                <br>
                <li>$|f+g|_{p}^{p} \leq|f|_{p}^{p}+|g|_{p}^{p} \quad$ for all $f, g \in X$</li>
                <br>
                <li>if $f_{n}$ converges to $f$ pointwise on $\mathbb{R},$ then $\lim _{n \rightarrow \infty}\left|f_{n}\right|_{p}=|f|_{p}$</li>
            </ol>
            ...
            <a href="problem42_2020.php"><div class="button prev">$\leftarrow$ Problem 42</div></a>
            <a href="problem44_2020.php"><div class="button next">Problem 44 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem43_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">43</button> </a>
