...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 24">
    <meta name="description" content="Let $\mathbb{Z}_{225}$ be the ring of integers modulo $225$. Let $x$ be the number of prime ideals and $y$ be the number of nontrivial units in $\mathbb{Z}_{225}$, then $x+y$ is equal to">
    <meta name="keywords" content="ring, prime ideals, maximal ideals, ideals, units, field, integers modulo, GATE 2020 mathematics problem 24, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-24 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-24</h2>
            ...
            <div class="content">
             <ul>
                 <li>The prime ideals of $\mathbb{Z}_{n}$ are $\langle p \rangle$, where $p$ is a prime that divides $n$. Now, 
                 $$225=3^2\cdot 5^2.$$
                 Thus $\mathbb{Z}_{225}$ have $2$ prime ideals $\langle 3 \rangle$ and $\langle 5 \rangle$. So $x=2$.
                 </li>
                 <li>The units of $\mathbb{Z}_{n}$ are the numbers $a$ such that $gcd(a,n)=1$. Thus the number of nontrivial units in $Z_n$ is $\phi(225)-1=225(1-\frac{1}{5})(1-\frac{1}{3})-1=120-1=119$. So $y=119$.
                 </li>
             </ul>

             Thus, $x+y=2+119=121$.
            </div><br><br>
            <a href="problem23_2020.php"><div class="button prev">$\leftarrow$ Problem 23</div></a>
            <a href="problem25_2020.php"><div class="button next">Problem 25 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem24_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">24</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 121";
    }
    </script>
