...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 15">
    <meta name="description" content="The number of cyclic subgroups of the quaternion group  $$  Q_8 = \left\langle a,b~|~ a^4=1,~a^2=b^2,~ba=a^3b \right\rangle$$ is">
    <meta name="keywords" content="group theory, cyclic, subgroups, quaternions, order, GATE 2020 mathematics problem 15, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    window.MathJax = {
        ...
        TeX: {
            ...
            Macros: {
                innerprod: ['{\\left\\langle #1 \\right\\rangle}', 1],
    ...
    <!-- Title -->
    <title>Problem-15 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-15</h2>
            The number of cyclic subgroups of the quaternion group 
            \begin{equation}
                Q_8 = \left\langle a,b~|~ a^4=1,~a^2=b^2,~ba=a^3b \right\rangle \tag{15.1} \label{eq: 2020_15.1}
            \end{equation}
            ...
            <div class="content">
                ...
                <span class="def-head">Cyclic subgroup: </span> Let $G$ be a group and let $g\in G$. The <span class="def">cyclic subgroup generated by $g$</span> is the subset 
                $$\langle g \rangle = \left\{g^n:n\in \bb{Z} \right\}$$
                
                <div class="theorem">
                    <strong>Theorem 1 (Lagrange's Theorem): </strong> Let $G$ be a finite group and $H$ be a subgroup of $G$. Let $|G|,~|H|$ denotes the number of elements of $G$ and $H$, respectively. Then $|H|$ divides $|G|$, i.e.,
                    \begin{equation}
                        |H|~\Big|~|G|
                    \end{equation}    
                </div>
                ...
                <div class="theorem">
                    <strong>Theorem 2 : </strong> Let $G$ be a finite group. Then the number of cyclic subgroups of order $k$ is $G$ is
                    \begin{equation*}
                        \dfrac{\text{number of elements of order $k$ in $G$}}{\phi(k)},
                    \end{equation*}
                    where $\phi(k)$ is the  Euler's phi function which is the number of positive integers less than $k$ that are relatively-prime to $k$. 
                </div>
            ...
            <div class="content">
                ...
                \begin{align*}
                    ...
                    & i^4 = j^4 = k^4 = 1. 
                \end{align*}
                Thus, we can write $Q_8$ as 
                $$ \langle i,j \rangle = \langle j,k \rangle = \langle k,i \rangle.$$
                <div class="text-box">
                    We can now solve the problem by listing all the cyclic subgroups, namely
                    \begin{align*}
                       & \innerprod{i}  = \{i,-1,1\},~~\innerprod{j}  = \{j,-1,1\},~~ \innerprod{k}  = \{k,-1,1\} \\
                       & \innerprod{-1} = \{-1,1\}~~\text{and}~~\innerprod{ 1} = \{1\}
                    \end{align*}
                </div>
                Since, the quaternion group has order $8$ and hence using the Theorem 1, the possible order of subgroups are  $1,2,4$ and $8$. Also we have
                \begin{align*}
                    & 1 ~~\text{element of of order}~~ 1 \\
                    & 1 ~~\text{element of of order}~~ 2 \\
                    & 6 ~~\text{element of of order}~~ 4.
                \end{align*}
                Now we will use Theorem 2 to find number of  cyclic subgroups of order $1,2,4$ and $8$.
                <br><br>
                <ul>
                    <li>
                        <span class="def-head">Number of cyclic subgroups of order $1:$</span>
                        \begin{align*}
                            & = \dfrac{\text{number of elements of order $1$ in $G$}}{\phi(1)}\\
                            & = \dfrac{1}{1}\\
                            & = 1.
                        \end{align*}
                    </li>
                    <li>
                        <span class="def-head">Number of cyclic subgroups of order $2:$</span>
                        \begin{align*}
                            & = \dfrac{\text{number of elements of order $2$ in $G$}}{\phi(2)}\\
                            & = \dfrac{1}{1}\\
                            & = 1.
                        \end{align*}
                    </li>
                    <li>
                        <span class="def-head">Number of cyclic subgroups of order $4:$</span>
                        \begin{align*}
                            & = \dfrac{\text{number of elements of order $4$ in $G$}}{\phi(4)}\\
                            & = \dfrac{6}{2}\\
                            & = 3.
                        \end{align*}
                    </li>
                    <li>
                        <span class="def-head">Number of cyclic subgroups of order $8:$</span>
                        \begin{align*}
                            & = \dfrac{\text{number of elements of order $8$ in $G$}}{\phi(8)}\\
                            & = \dfrac{0}{4}\\
                            & = 0.
                        \end{align*}
                    </li>
                </ul>
                Thus, the total number of cyclic subgroups of $Q_8$ is $1+1+3+0 = 5$.
            </div><br><br>
            <a href="problem14_2020.php"><div class="button prev">$\leftarrow$ Problem 14</div></a>
            <a href="problem16_2020.php"><div class="button next">Problem 16 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem15_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">15</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 5";
    }
    </script>
