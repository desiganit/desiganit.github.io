...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 19">
    <meta name="description" content="Let $a,b,c\in \mathbb{R}$ be such that the quadrature rule $$\int_{-1}^1f(x)dx\sim af(-1)+bf(0)+cf'(1)$$ is exact for all polynomials of degree less or equal to 2. Then">
    <meta name="keywords" content="numerical analysis, quadrature rule, approximation, polynomials, GATE 2020 mathematics problem 19, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-19 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-19</h2>
            Let $a,b,c\in \mathbb{R}$ be such that the quadrature rule $$\int_{-1}^1f(x)dx\sim af(-1)+bf(0)+cf'(1)$$ is exact for all polynomials of degree less or equal to 2. Then $b$ is equal to $\_\_\_\_\_$. (rounded off to two decimal places).
            ...
            <div class="content">
             As the quadrature rule is exact for all polynomial of degree less than or equal to $2$, so let us take $f(x)=x+1,x^2-1$ respectively and will get the following relations:
               \begin{align*}
                   &\int_{-1}^1(x+1)dx=b+c\\
                   &\int_{-1}^1(x^2-1)dx=-b+2c\\
                   i.e.,\ &2=b+c\\
                   &-\frac{4}{3}=-b+2c\\
                   \Rightarrow & b=\frac{1}{3}(4+\frac{4}{3}) =\frac{16}{9}=1.77777\cdots
               \end{align*}

            </div><br><br>
            <a href="problem18_2020.php"><div class="button prev">$\leftarrow$ Problem 18</div></a>
            <a href="problem20_2020.php"><div class="button next">Problem 20 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem19_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">19</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 1.78";
    }
    </script>
