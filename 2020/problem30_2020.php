...
<head>
    ...
    <meta name="title" content="Problem-30 MA-2020">
    <meta name="description" content="Let $P(\mathbb{R})$ denote the power set of $\mathbb{R}$, equipped with the metric">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 30, solution of problem 30, gate ma 2020 problem 30 solution, Let $P(\mathbb{R})$ denote the power set of $\mathbb{R}$, equipped with the metric">
    ...
    <!-- Title -->
    <title>Problem-30 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-30</h2>
            ...
            <br><br>
            <ol type="A">
                <li>bounded but not totally bounded.</li>
                <br>
                <li>totally bounded but not compact.</li>
                <br>
                <li>compact.</li>
                <br>
                <li>not bounded.</li>
            ...
            <div class="content">
                ...
                First note as by definition of characteristic function, 
                $$\chi_U(x)=\left\{\begin{array}{cl} 1, & \text{ if }x\in U \\
                                     0, & \text{ if }x\notin U
                                   \end{array}\right.$$
                So, 
                \begin{align*}
                    d(U,V)&=\sup_{x\in \mathbb{R}}\left|\chi_U(x)-\chi_V(x)\right|\\
                    &=\left\{\begin{array}{cl}
                         0, & \text{ if }U=V \\
                         1, & \text{ if }U\neq V
                    \end{array}\right.
                \end{align*}
                (as if $U\neq V$, then there exists $x\in (U-V)\cup (V-U)$ so that $d(U,V)=1$).<br>
                So the metric $d$ on $P(\mathbb{R})$ is nothing but the discrete metric on it.
              
             <h3 class="options">(A) bounded but not totally bounded.</h3>
                Consider the ball around $\{0\}$ of radius $2$ i.e., $B_2(\{0\})$. Then 
                \begin{align*}
                    B_2(\{0\})&=\{U\in P(\mathbb{R}):d(U,\{0\})<2\}\\
                    &=\{U\in P(\mathbb{R}):d(U,\{0\})=0\text{ or }1\}\\
                    &=P(\mathbb{R}) \text{, as the only possible values of }d\text{ are }0,1.
                \end{align*}
                So $\{\{m\}:m\in \mathbb{Z}\}\subset P(\mathbb{R}\}=B_2(\{0\})$ and hence the set is bounded.<br>
                But it is not totally bounded because if we take $r=0.5$, then $B_r(U)=\{U\}$, so there is no finite set of points of $\{\{m\}:m\in \mathbb{Z}\}$ such that the ball of radius $r$ around those points can cover $\{\{m\}:m\in \mathbb{Z}\}$ (as the set is infinite). So this is <strong>TRUE</strong>.
               <br><br>

             <h3 class="options">(B) totally bounded but not compact.</h3>
                From above discussion we clearly see that the set is not totally bounded. So this is <strong>FALSE</strong>.
               <br><br>

             <h3 class="options">(C) compact.</h3>
               If we consider the open cover $\{B_r(\{m\})\}_{m\in \mathbb{Z}}$ for $r=0.5$ of the given set, then as the collection is disjoint, so clearly it has no finite subcover and consequently it is not compact. So this is <strong>FALSE</strong>.
               <br><br>

             <h3 class="options">(D) not bounded.</h3>
                By (A), clearly the given set is bounded. So this is <strong>FALSE</strong>.

             <br><br>

            <font color="blue">General Facts:-</font> In the same line of argument one can prove that<br>
            <ol type="i">
                <li>any set in discrete metric is bounded (also any set is both closed and open, so gives a counter example for Heine-Borel theorem).</li>
                <br>
                <li>the only compact sets in discrete metric are finite sets.</li>
                <br>
                <li>no infinite set is totally bounded in discrete metric.</li>
            </ol>

            </div><br><br>
            <a href="problem29_2020.php"><div class="button prev">$\leftarrow$ Problem 29</div></a>
            <a href="problem31_2020.php"><div class="button next">Problem 31 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem30_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">30</button> </a>
