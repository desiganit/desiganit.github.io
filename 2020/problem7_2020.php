...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 7">
    <meta name="description" content="Suppose that  \begin{align*}    U&=\mathbb{R}^2\setminus \{(x,y)\in \mathbb{R}^2\,:\,x,y\in \mathbb{Q}\}\\  U&=\mathbb{R}^2\setminus \left\{(x,y)\in \mathbb{R}^2\,:\,x>0,\,y=\frac{1}{x}\right\}  \end{align*} Then, with respect to the Euclidean metric on $\mathbb{R}^2,$">
    <meta name="keywords" content="Euclidean metric, topology, connectedness, GATE 2020 mathematics problem 7, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-7</h2>
                ...
                U&=\mathbb{R}^2\setminus \{(x,y)\in \mathbb{R}^2\,:\,x>0,\,y=\frac{1}{x}\}
                \end{align*}
                Then, with respect to the Euclidean metric on $\mathbb{R}^2,$
            <ol type="A">
                <li>both $U$ and $V$ are disconnected</li>
                <li>$U$ is disconnected but $V$ is connected</li>
                <li>$U$ is connected but $V$ is disconnected</li>
                <li>both $U$ and $V$ are connected</li>
            </ol>
            ...
            <div class="content">
                ...
                <ol>
                    <li>Euclidean metric on $\rbb^2$ is given by $$d((x_1,y_1),(x_2,y_2))=\sqrt{(x_1-x_2)^2+(y_1-y_2)^2}$$ </li> 
                    <li> </li> 
                    <li> </li>
                </ol>
            ...
            <div class="content">
                ...
                <!-- Option A (if exists) -->
                <h3 class="option-A">(A)       </h3>
                 

                <!-- Option B (if exists) -->
                <h3 class="options">(B)        </h3>
                 

                <!-- Option C (if exists) -->
                <h3 class="options">(C)        </h3>
                

                <!-- Option D (if exists) -->
                <h3 class="options">(D)        </h3>
                 
            </div><br><br>
            <a href="problem6_2020.php"><div class="button prev">$\leftarrow$ Problem 6</div></a>
            <a href="problem8_2020.php"><div class="button next">Problem 8 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem7_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">7</button> </a>
