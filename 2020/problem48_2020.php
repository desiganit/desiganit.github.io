...
<head>
    ...
    <meta name="title" content="Problem-48 MA-2020">
    <meta name="description" content="Let $\alpha \in \mathbb{R}$. If $(3,0,0, \beta)$ is an optimal solution">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 48, solution of problem 48, gate ma 2020 problem 48 solution, Let $\alpha \in \mathbb{R}$. If $(3,0,0, \beta)$ is an optimal solution">
    ...
    <!-- Title -->
    <title>Problem-48 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-48</h2>
            ...
            \end{array}
            $$
            then the maximum value of $\beta-\alpha$ is $\_\_\_\_\_$
            ...
            <a href="problem47_2020.php"><div class="button prev">$\leftarrow$ Problem 47</div></a>
            <a href="problem49_2020.php"><div class="button next">Problem 49 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem48_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">48</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 7";
    }
    </script>
