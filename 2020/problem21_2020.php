...
<head>
    ...
    <meta name="title" content="GATE-MA-2020 Problem 21">
    <meta name="description" content="For $n\geq 2$ define the sequence $\{x_n\}$ by  $$x_n=\dfrac{1}{2\pi}\int_{0}^{\frac{\pi}{2}}\tan^{\frac{1}{n}}t \,{\rm d}t.$$ Then the sequence $\{x_n\}$ converges to">
    <meta name="keywords" content="sequence, convergence, integration, analysis, GATE 2020 mathematics problem 21, GATE 2020 MA, gate mathematics, GATE MA, gate 2020, mathematics, Gate mathematics solution, ">
    ...
    <!-- Title -->
    <title>Problem-21 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-21</h2>
            For $n\geq 2$ define the sequence $\{x_n\}$ by 
            $$x_n=\dfrac{1}{2\pi}\int_{0}^{\frac{\pi}{2}}\tan^{\frac{1}{n}}t \,{\rm d}t.$$
            Then the sequence $\{x_n\}$ converges to $\_\_\_\_\_$(correct up to two decimal places.)
            ...
            \begin{equation}
            \int_{0}^{\frac{\pi}{2}}\tan^{\frac{1}{n}}t \,{\rm d}t=\int_{0}^{\frac{\pi}{4}}\tan^{\frac{1}{n}}t \,{\rm d}t+\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}\tan^{\frac{1}{n}}t \,{\rm d}t=\text{I}+\text{II} \,\,(\text{say})
            \end{equation}
            For $n\geq 2$ define the sequence of functions $\{f_n\}$ by 
             $$f_n(t)=\tan^{\frac{1}{n}} t.$$
             Then
            $$f(t)=\lim_{n\to \infty} f_n(t)=\lim_{n\to \infty} \tan^{\frac{1}{n}} t=1.$$
            Now, for $t\in [0, \frac{\pi}{4}]$, we have
            \begin{align*}
            0\leq \tan t\leq 1&\implies \tan^{\frac{1}{n}} t\leq 1, \text{ for all } n\in \mathbb{N}\\
            \end{align*}
            That is $\{f_n\}$ is uniformly bounded in the interval $[0, \frac{\pi}{4}]$. Thus, by Bounded convergence theorem we have
            \begin{align*}
            \lim_{n\to \infty}\int_{0}^{\frac{\pi}{4}}\tan^{\frac{1}{n}}t \,{\rm d}t&=\int_{0}^{\frac{\pi}{4}}\lim_{n\to \infty}\tan^{\frac{1}{n}}t \,{\rm d}t\\
            &=\int_{0}^{\frac{\pi}{4}} 1\,{\rm d}t\\
            &=\frac{\pi}{4}.
            \end{align*}
            For $t\in [\frac{\pi}{4}, \frac{\pi}{2}]$, we have
            \begin{align*}
            \tan t\geq 1&\implies \tan^p t\geq \tan t , \text{ for } p>1\\
            &\implies \tan^{\frac{m}{n}} t\geq \tan t, \text{ for } m>n\\
            &\implies \tan^{\frac{1}{n}} t\geq \tan^{\frac{1}{m}} t, \text{ for } m>n
            \end{align*}
            That is, $\{f_n\}$ is decreasing and so $\{-f_n\}$ will be increasing. Hence, if we define 
            $$g_n=f_2-f_n,$$
            then, $\{g_n\}$ will be increasing and $g_n \geq 0$ (since $f_n\leq f_2$ for all $n$).
            Now, we will show that $f_2$ is integrable on $[\frac{\pi}{4}, \frac{\pi}{2}]$. Note that $\tan t >0 $ in $[\frac{\pi}{4}, \frac{\pi}{2}]$. Thus 
            \begin{align*}
            \int_{\frac{\pi}{4}}^{\frac{\pi}{2}} |\tan^{\frac{1}{2}} t| {\rm d}t &=\int_{\frac{\pi}{4}}^{\frac{\pi}{2}} \tan^{\frac{1}{2}} t {\rm d}t\\
            &=\int_{1}^{\infty} \dfrac{2x}{1+x^4}\,{\rm d}x\equiv \int_{1}^{\infty} \dfrac{1}{x^3}\,{\rm d}x<\infty.
            \end{align*}
            Thus, applying Monotone convergence theorem to $\{g_n\}$ we have that
            \begin{align*}
              &\lim_{n\to \infty}\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}f_2(t)-f_n(t)=\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}\lim_{n\to \infty} \left(f_2(t)-f_n(t)\right)\\
              \implies & \lim_{n\to \infty}\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}f_2(t)-\lim_{n\to \infty}\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}f_n(t)=\lim_{n\to \infty}\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}f_2(t)-\int_{\frac{\pi}{4}}^{\frac{\pi}{2}} 1 dt\\
              \implies & \lim_{n\to \infty}\int_{\frac{\pi}{4}}^{\frac{\pi}{2}}f_n(t)=\frac{\pi}{2}-\frac{\pi}{4}=\frac{\pi}{4}\\
              \implies & \lim_{n\to \infty}\int_{\frac{\pi}{4}}^{\frac{\pi}{2}} \tan^{\frac{1}{n}} t\,{\rm d}t=\frac{\pi}{4}.
            \end{align*}
            Using $(1.10)$ and $(1.11)$ in $(1.9)$ we get
            $$\lim_{n\to \infty}x_n=\lim_{n\to \infty}\dfrac{1}{2\pi}\int_{0}^{\frac{\pi}{2}}\tan^{\frac{1}{n}}t \,{\rm d}=\dfrac{1}{2\pi}\left(\dfrac{\pi}{4}+\dfrac{\pi}{4}\right)=\dfrac{1}{4}.$$
            Thus $\{x_n\}$ converges to $0.25$.

            </div><br><br>
            <a href="problem20_2020.php"><div class="button prev">$\leftarrow$ Problem 20</div></a>
            <a href="problem22_2020.php"><div class="button next">Problem 22 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem21_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">21</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 0.25";
    }
    </script>
