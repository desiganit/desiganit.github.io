...
<head>
    ...
    <meta name="title" content="Problem-51 MA-2020">
    <meta name="description" content="Let $\vec{F}=(x+2y)e^z\hat{i}\,+\,(ye^z+x^2)\hat{j}+y^2z\hat{k}$">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 51, solution of problem 51, gate ma 2020 problem 51 solution, Let $\vec{F}=(x+2y)e^z\hat{i}\,+\,(ye^z+x^2)\hat{j}+y^2z\hat{k}$">
    ...
    <!-- Title -->
    <title>Problem-51 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-51</h2>
            ...
            $$\bigg|\iint\limits_{S}\left( &nabla; \times\vec{F}\right)\cdot \hat{n} \,dS\bigg|=\alpha \pi.$$
            Then $\alpha$ is equal to $\_\_\_\_\_$
            ...
            <div class="content">
             ...
             By Stokes' theorem
            \begin{align*}
            \iint\limits_{S}\left(&nabla;\times\vec{F}\right)\cdot \hat{n} \,dS=\oint\limits_{C} \vec{F}\cdot {\rm d}r.
            \end{align*}
            The parametrization of the given curve $C$ is
            $$r(t)=(x(t),y(t),z(t))=(\cos t,\sin t, 0), ~~t\in [0,2\pi)$$
            and so
            $$r'(t)=(-\sin t, \cos t, 0). $$
            Now
            \begin{align*}
            \oint\limits_{C} \vec{F}\cdot {\rm d}r&=\oint\limits_{C} \vec{F}(r(t))\cdot r'(t)\,{\rm d}t\\
            &=\int\limits_{0}^{2\pi} (\cos t+2\sin t, \sin t+\cos^2 t, 0)\cdot (-\sin t, \cos t , 0)\,{\rm d}t\\
            &=\int\limits_{0}^{2\pi}\left(-\cos t\sin t-2\sin^2t+\sin t\cos t+\cos^3t\right)\,{\rm d}t\\
            &=\int\limits_{0}^{2\pi}\left(\cos 2t-1\right)+\dfrac{1}{4}\left(\cos 3t+\cos t\right)\,{\rm d}t\\
            &=\left(\dfrac{\sin 2t}{2}-t+\dfrac{1}{4}\left(\dfrac{\sin 3t}{3}+\sin t\right)\right)\bigg|_{0}^{2\pi}=-2\pi.
            \end{align*}
            Thus by Stokes' theorem
            \begin{align*}
            \bigg|\iint\limits_{S}\left(&nabla;\times\vec{F}\right)\cdot \hat{n} \,dS\bigg|=\bigg|\oint\limits_{C} \vec{F}\cdot {\rm d}r\bigg|=|-2\pi|=2\pi.
            \end{align*}
            Hence, $\alpha=2.$
            ...
            <a href="problem50_2020.php"><div class="button prev">$\leftarrow$ Problem 50</div></a>
            <a href="problem52_2020.php"><div class="button next">Problem 52 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem51_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">51</button> </a>
...
<script>
    ...
    <script>
      // for see answer 
    function seeAnswer() {
        document.getElementById("answer").innerHTML = "Answer is 2";
    }
    </script>
