...
<head>
    ...
    <meta name="title" content="Problem-42 MA-2020">
    <meta name="description" content="Let $\alpha, \beta \in \mathbb{R}, \alpha \neq 0 .$">
    <meta name="keywords" content="gate mathematics, Gate MA 2020, Gate MA, problem 42, solution of problem 42, gate ma 2020 problem 42 solution, Let $\alpha, \beta \in \mathbb{R}, \alpha \neq 0 .$">
    ...
    <!-- Title -->
    <title>Problem-42 MA-2020</title>
    ...
    <!-- End of the header code -->
     ...
     <div class="container">
        <div class="jumbotron jumbotron-math">
            ...
            <h2 class="problem">Problem-42</h2>
          Let $\alpha, \beta \in \mathbb{R}, \alpha \neq 0 .$ The system 
          $$\begin{array}{c} x_{1}-2 x_{2}+\alpha x_{3}=8 \\
                       x_{1}-x_{2}+x_{4}=\beta \\
                       x_{1}, x_{2}, x_{3}, x_{4} \geq 0
            \end{array}$$ has NO basic feasible solution if
            <br><br>
            <ol type="A">
                <li> $\alpha< 0, \beta >8$ </li>
                <br>
                <li>$\alpha >0,0< \beta< 8$</li>
                <br>
            ...
            <a href="problem41_2020.php"><div class="button prev">$\leftarrow$ Problem 41</div></a>
            <a href="problem43_2020.php"><div class="button next">Problem 43 $\rightarrow$</div></a>
        </div>
    </div>
...
<div class="container">
    <div class="jumbotron jumbotron-custom xyz">
        ...
        <a href="problem42_2020.php" style="text-decoration: none";><button type="button" class="btn btn-primary btn-circle btn-md">42</button> </a>
